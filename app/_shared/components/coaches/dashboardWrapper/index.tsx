...
import { coachesDashboardConstants } from "utils/constants";
...
function CoachesDashboardWrapper({ children, user }: Props) {
  ...
  return (
    <div className={classNames(styles.topLevelContainer, "p-0 m-0 ")}>
      <DashboardSideCanvas
        ...
        sidebarArr={coachesDashboardConstants}
      />
      <aside
        className={classNames(styles.sideNavContainer, styles.sideNavFull)}
        id="sideNav"
      >
        <DashboardSidebar sidebarArr={coachesDashboardConstants} />
      </aside>
...
export default CoachesDashboardWrapper;
